...
global.inFrontOf = function(pos, heading, dist) {
  heading *= Math.PI / 180
...
global.generateEntityList = function() {
  let list = {}
...
global.selectObject = function(obj) {
...
global.deselectObject = function() {
  if (boxRender)
    boxRender.destroy()
  if (boxMarker)
    boxMarker.destroy()
...
global.createEntity = function(entity, pos) {
  if (entity == 'marker')
...
global.syncEntity = function(ent) {
